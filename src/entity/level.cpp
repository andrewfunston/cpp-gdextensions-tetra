...
[[signal_slot]] void Level::on_physics_box_entered(godot::Node *node) const {
    console::get()->print("{} > {}", io::yellow("projectile"), to<std::string>(node->get_name()));
}

[[signal_slot]] void Level::on_physics_box_exited(godot::Node *node) const {
    console::get()->print("{} < {}", io::red("projectile"), to<std::string>(node->get_name()));
}

[[signal_slot]] void Level::on_player_spawn_projectile(godot::Node *obj) {
...
[[signal_slot]] void Level::on_character_position_changed(const godot::Object *const node,
