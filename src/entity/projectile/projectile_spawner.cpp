...
namespace rl {
[[nodiscard]] Projectile *ProjectileSpawner::spawn_projectile() {
...
[[property]] double ProjectileSpawner::get_fire_rate() const {
    return m_fire_rate;
}

[[property]] void ProjectileSpawner::set_fire_rate(double fire_rate) {
